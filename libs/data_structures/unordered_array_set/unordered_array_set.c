...
size_t unordered_array_set_in(unordered_array_set* set, int value) {
    return linear_search_(set -> data, set -> size, value);
}
...
void unordered_array_set_delete_element(unordered_array_set* set, int value) {size_t index_value = unordered_array_set_in(set, value);
...
unordered_array_set unordered_array_set_complement(unordered_array_set set, unordered_array_set universum_set) {
    ...
    assert(unordered_array_set_is_subset(new_set, universum_set));
